...
\begin{figure*}[t!]
 ...
 \caption{\textrm{%
  ...
  0.001. D: Classification \textcolor{red}{RD: please explain
    briefly.}
  }
 }\label{fig:bcancer} 
\end{figure*}
...
\cite{ANat}.\footnote{\textcolor{red}{RD:explain how do we simulate
    $E$ and how do we add extra noise}}
...
The data set was analysed * times with \texttt{signeR} and EMu. Emu
estimated the correct number of signatures only * of all the
...
\begin{figure}  
 \centering
  ...
  \caption{\textrm{%
    Squared sum of errors for the $P$ and $E$ estimates of a 4
...
\begin{figure}  
 \centering
  \includegraphics[width=6cm]{figs/Simulation_signeR_vs_EMu_histogram_LLh}
  \caption{\textrm{%
   Log likelihood values at the estimates for $P$ and $E$
   obtained by the analysis of a 4 signature synthetic data set via
